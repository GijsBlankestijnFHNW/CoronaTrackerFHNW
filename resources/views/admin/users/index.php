...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                <h3 class="text-dark mb-4">Registrations</h3>
                <a href="<?php echo url('admin/archieved-users'); ?>"><button class="btn btn-primary btn-sm d-sm-inline-block" type="button"><i class="fa fa-trash"></i> Archived users</button></a>
    </div>
                            ...
                            <table class="table my-0" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo url('admin/edit-user/'.$row->id); ?>"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
